...
replace (
	...
	github.com/codegangsta/cli => github.com/urfave/cli v1.22.9
	github.com/mickep76/iodatafmt => github.com/novaez/iodatafmt v0.0.0-20181025080428-cec58d0bdc35
	github.com/coreos/etcd => github.com/etcd-io/etcd v2.3.1-0.20160502184358-a8139e2b0e23+incompatible
	)